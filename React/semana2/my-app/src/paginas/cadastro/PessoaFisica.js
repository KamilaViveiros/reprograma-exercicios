            ...
            <div className="pagina">
                ...
                <form className="formulario" onSubmit={this.handleSubmit}>
                    ...
                    <Grupo erro={this.state.numerocpf.erro}>
                        ...
                        <Grupo.CaixaTexto required={true} type="number" placeholder="000.000.000-00" id="numerocpf" value={this.state.numerocpf.valor} name="numerocpf" onChange={this.handleChange}>
                    ...
                    <Grupo erro={this.state.datanascimento.erro}>
                        ...
                        <Grupo.CaixaTexto required={true} type="text" placeholder="dd/mm/aaaa" id="datanascimento" value={this.state.datanascimento.valor} name="datanascimento" onChange={this.handleChange}>
                    ...
                    <Grupo erro={this.state.email.erro}>
                        ...
                        <Grupo.CaixaTexto required={true} type="text" placeholder="Email" id="email" value={this.state.email.valor} name="email" onChange={this.handleChange} >
                    ...
                    <Grupo erro={this.state.senha.erro}>
                        ...
                        <Grupo.CaixaTexto required={true} type="password" placeholder="Senha" id="senha" value={this.state.senha.valor} name="senha" onChange={this.handleChange} >

                        </Grupo.CaixaTexto>
                    </Grupo>
                    <BotaoSubmit desabilitado={desabilitado} acaoBotao={this.handleChange} className="botao">
                        Enviar
                    </BotaoSubmit>
