        ...
        return (
            <div className="pagina">
                ...
                <form className="formulario" onSubmit={this.handleSubmit}>
                    ...
                    <input className="campo" type="text" placeholder="Razao Social" id="nomeSobrenome" value={this.state.nomeSobrenome} name="nomeSobrenome" onChange={this.handleChange} />
                    </div>

                    <div>
                    <label htmlFor="cnpj">CNPJ:</label>
                    <input className="campo" type="text" placeholder="CNPJ" id="cnpj" value={this.state.numerocpf} name="cnpj" onChange={this.handleChange} />
                    </div>

                    <div>
                    <label htmlFor="cep">CEP:</label>
                    <input className="campo" type="text" placeholder="00000-000" id="cep" value={this.state.datanascimento} name="cep" onChange={this.handleChange} />
                    </div>
